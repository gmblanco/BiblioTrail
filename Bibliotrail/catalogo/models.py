...
class Prestamo(models.Model):
    usuario = models.ForeignKey(PerfilUsuario, on_delete=models.CASCADE, help_text="Seleccione el usuario asociado a este préstamo")
    ...
    def __str__(self):
        return f'{self.ejemplar.libro.titulo} - {self.usuario.user.username} ({self.estado})'
